 ...
 */
export const tocToHast = (headings: HastHeading[] = [], variables?: Variables): TocList => {
 ...
 * @param variables - Optional user variables for resolving Variable nodes in headings
 */
export const tocHastToMdx = (
  toc: IndexableElements[] | undefined,
  components: Record<string, RMDXModule['toc']>,
  variables?: Variables,
) => {
  ...
  const tocHast = tocToHast(injected as HastHeading[], variables);
