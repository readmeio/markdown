...
import resolveJsxAttributeExpressionProps from '../processor/transform/mdxish/resolve-jsx-attribute-expression-props';
...
export function mdxish(mdContent: string, opts: MdxishOpts = {}): Root {
  ...
  processor
    ...
    .use(safeMode ? undefined : resolveJsxAttributeExpressionProps) // Evaluate deferred JSX attribute expressions (now past rehypeRaw's clone)
