...
`,
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(
      '"<blockquote class="callout callout_warn" theme="🚧"><span class="callout-icon Icon-emoji">🚧</span><p class="callout-heading empty"></p><p>Callout with no title.</p></blockquote>"',
    );
