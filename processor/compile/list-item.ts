...
// reachable because the stringifier honors stamped `bullet` markers (see
// ListWithMarker in lib/mdxish.ts); without it here, checkbox injection below
// silently no-ops for ordered ')' task lists.
